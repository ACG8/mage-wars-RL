...
fov_recompute = True
global dungeon_level, player, training, antitraining, stairs, game_state, game_msgs, inventory, spellbook, objects, dungeon, dungeon_unblocked_list, player_location_changed, autoplaying
